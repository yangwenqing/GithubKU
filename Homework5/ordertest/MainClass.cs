    ...
    class MainClass {
        public static void Main() {
            try
            {
                ...
                Goods milk = new Goods(1, "Milk", 100);
                Goods eggs = new Goods(2, "eggs", 20);
                Goods apple = new Goods(3, "apple", 200);

                OrderDetail orderDetails1 = new OrderDetail(1, apple, 40);
                OrderDetail orderDetails2 = new OrderDetail(2, eggs, 100);
                ...
                Console.WriteLine("GetOrdersByValue:'10000'");
                orders = os.QueryByValue(10000);
                foreach (Order od in orders)
                    Console.WriteLine(od.ToString());
